...
class ItemsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'supplier_id' => ['type' => 'integer', 'length' => 10, 'unsigned' => true, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        'purchase_price' => ['type' => 'integer', 'length' => 10, 'unsigned' => true, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'purchase_price' => 1,
                'stock' => 1,
                'created' => '2020-01-26 14:27:44',
                'modified' => '2020-01-26 14:27:44',
                'name' => 'item1'
            ],
        ];
        parent::init();
